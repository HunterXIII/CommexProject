...
SECRET_KEY = 'django-insecure-93#r#!esa^hcq-)oq&cd=m@h!*@xd)m^ob6l*q0l^fv(tcvm7s'
...
WSGI_APPLICATION = 'commex.wsgi.application'
...
AUTH_USER_MODEL = 'main.MessengerUser'
...
ASGI_APPLICATION = "commex.asgi.application"
CHANNEL_LAYERS = {
    "default": {
